...
<head>
    ...
    <style>
        ...
        .tile{
            ...
            width: 220px;
            height: auto;
            border: 1px solid #006400; /* Verde bandera */
            position: relative;
            cursor: pointer;
            margin: 10px;
        ...
        .tile:hover .tile-icon i{
            transform: scale(1.5);
            color: #004d00; /* Verde más oscuro al hover */
        }
    </style>
</head>
<body>
            ...
            if($_SESSION['CheckConfig']=='unrevised'){
                ...
                if((mysqli_num_rows($checkReservation)>=1 || mysqli_num_rows($checkLoanPending)>=1) && $DataInsT['Year']!=$Year){
                    ...
                    echo '<script type="text/javascript">
                        swal({ 
                            title:"¡Importante!", 
                            text:"Bienvenido Administrador <strong>'.$_SESSION['UserName'].'</strong><br>Hay devoluciones pendientes o reservaciones por aprobar.", 
                            type: "warning",
                            html: true,
                            animation: "slide-from-top",
                            confirmButtonText: "Aceptar" 
