...
if(mysqli_num_rows($selectTeacher)>=1){
    echo '
    <legend class="all-tittles">DATOS BÁSICOS</legend><br>
    ...
    <div class="group-material">
        <input type="text" class="material-control tooltips-general" value="'.$dataTeacher["Telefono"].'" name="teachingPhone" pattern="[0-9+]{5,20}" required="" maxlength="20" data-toggle="tooltip" data-placement="top" title="Solamente números y símbolo +">
        <span class="highlight"></span>
        <span class="bar"></span>
    ...
    <legend class="all-tittles">TURNO Y SECCIÓN ENCARGADA</legend><br>
    <div class="group-material">
        <select class="material-control tooltips-general" name="teachingSection" data-toggle="tooltip" data-placement="top" title="Elige la sección encargada del docente">';
            ...
            if($dataSection['CodigoSeccion']!=""){
                echo '<option value="Sin asignar">Sin asignar</option>';
                echo '<option value="'.$dataSection['CodigoSeccion'].'" selected="">'.$dataSection['Nombre'].'</option>';
            }else{
                echo '<option value="Sin asignar" selected="">Sin asignar</option>';
            }
    ...
    <legend class="all-tittles">DATOS DE LA CUENTA</legend><br>
    ...
    <legend class="all-tittles">CAMBIO DE CONTRASEÑA</legend><br>
