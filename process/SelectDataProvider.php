...
if(mysqli_num_rows($selectProvider)>=1){
    ...
    <div class="group-material">
        <input type="text" class="material-control tooltips-general" value="'.$dataProvider['Telefono'].'" name="providerPhone" required="" pattern="[0-9+]{5,20}" maxlength="20" data-toggle="tooltip" data-placement="top" title="Solo números y símbolo">
        <span class="highlight"></span>
        <span class="bar"></span>
