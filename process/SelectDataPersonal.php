...
if(mysqli_num_rows($selectPersonal)>=1){
    ...
    <div class="group-material">
        <input type="text" class="material-control tooltips-general" value="'.$dataPersonal["Telefono"].'" name="personalPhone" pattern="[0-9+]{5,20}" required="" maxlength="20" data-toggle="tooltip" data-placement="top" title="Solamente números y símbolo +">
        <span class="highlight"></span>
        <span class="bar"></span>
