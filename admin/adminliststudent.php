    ...
    <script>
        $(document).ready(function(){
            ...
            $('.btn-del-student').on('click', function(){
                var action="../process/DeleteStudent.php";
                var NIE=$(this).attr('data-nie');
                swal({
                    title: "¿Quieres eliminar el estudiante?",
                    text: "El estudiante será eliminado del sistema completamente",
                    type: "info",
...
<body>
    ...
    <div class="content-page-container full-reset scroll">
        ...
        <div class="container-fluid" style="margin: 0 0 50px 0;">
            <form class="pull-right" style="width: 30% !important;" action="adminliststudent.php" method="get" autocomplete="off">
                <div class="group-material">
                    <input type="search" style="display: inline-block !important; width: 70%;" class="material-control tooltips-general" placeholder="Buscar estudiante" name="StudentN" required="" data-toggle="tooltip" data-placement="top" title="Escribe los nombres, apellidos o Matricula del estudiante">
        ...
        <?php
            if(isset($_POST['niecheck'])){
                include "../process/UpdateSectionStudent.php";
            }
        ?>
        <form action="" method="POST" class="container-fluid">
            ...
            <?php
                    ...
                    echo '<div class="table-responsive">
                        <div class="div-table" style="margin:0 !important;">
                            <div class="div-table-row div-table-row-list" style="background-color:#DFF0D8; font-weight:bold;">
                                ...
                                <div class="div-table-cell" style="width: 17%;">Matricula</div>
                                <div class="div-table-cell" style="width: 17%;">Apellidos</div>
                                <div class="div-table-cell" style="width: 17%;">Nombres</div>
                                <div class="div-table-cell" style="width: 17%;">Sección</div>
                                <div class="div-table-cell" style="width: 4%;">Marcar</div>
                ...
                if(!$StudentN==""){
                    $selectStudentByName=ejecutarSQL::consultar("SELECT * FROM estudiante WHERE Nombre LIKE '%".$StudentN."%' OR NIE LIKE '%".$StudentN."%' OR Apellido LIKE '%".$StudentN."%' ORDER BY Apellido ASC, Nombre ASC");
                    if(mysqli_num_rows($selectStudentByName)>0){
                                ...
                                <div class="table-responsive">
                                    <div class="div-table" style="margin:0 !important;">
                                        <div class="div-table-row div-table-row-list">
                                            ...
                                            <div class="div-table-cell" style="width: 17%;">'.$dataSN['Matricula'].'</div>
                                            <div class="div-table-cell" style="width: 17%;">'.$dataSN['Apellido'].'</div>
                                            <div class="div-table-cell" style="width: 17%;">'.$dataSN['Nombre'].'</div>
                                            <div class="div-table-cell" style="width: 17%;">'.$dataS['Nombre'].'</div>
                                            <div class="div-table-cell" style="width: 4%;"><input type="checkbox" name="niecheck[]" value="'.$dataSN['NIE'].'"></div>
                                            ...
                                            <div class="div-table-cell" style="width: 9%;">
                                                <button type="button" class="btn btn-danger btn-del-student" data-nie="'.$dataSN['NIE'].'"><i class="zmdi zmdi-delete"></i></button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        echo '<br><br><br><h3 class="text-center all-tittles">No existe ningún estudiante registrado con los nombres, apellidos o Matricula "'.$StudentN.'"</h3><br><br>';
                    }
                            ...
                            echo '<li>
                                <div class="table-responsive">
                                    <div class="div-table" style="margin:0 !important;">
                                        <div class="div-table-row div-table-row-list">
                                            <div class="div-table-cell" style="width: 6%;">'.$c.'</div>
                                            <div class="div-table-cell" style="width: 17%;">'.$dataSS['Matricula'].'</div>
                                            <div class="div-table-cell" style="width: 17%;">'.$dataSS['Apellido'].'</div>
                                            <div class="div-table-cell" style="width: 17%;">'.$dataSS['Nombre'].'</div>
                                            <div class="div-table-cell" style="width: 17%;">'.$dataSt['Nombre'].'</div>
                                            <div class="div-table-cell" style="width: 4%;"><input type="checkbox" name="niecheck[]" value="'.$dataSS['NIE'].'"></div>
                                            ...
                                            <div class="div-table-cell" style="width: 9%;">
                                                <button type="button" class="btn btn-danger btn-del-student" data-nie="'.$dataSS['NIE'].'"><i class="zmdi zmdi-delete"></i></button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="container-fluid">
                <div class="row">
                    <?php
                        $selAllSection= ejecutarSQL::consultar("SELECT * FROM seccion ORDER BY Nombre");
                        if(mysqli_num_rows($selAllSection)>=1):
                    ?>
                    <div class="col-xs-12">
                        <h2 class="text-center all-tittles" style="margin: 25px 0; clear: both;">Mover de sección a varios estudiantes</h2>
                        <p class="text-center">
                            Para cambiar de sección varios estudiantes por favor marque la casilla "Marcar" de cada estudiante, a continuación elija la sección a la que desea cambiarlos y haga clic en “Mover estudiantes”
                        </p>
                    </div>
                    <div class="col-xs-12 col-sm-8 col-sm-offset-2">
                        <div class="group-material">
                            <span>Sección</span>
                            <select class="material-control tooltips-general" name="newSection" data-toggle="tooltip" data-placement="top" title="Elija la sección a la que movera los estudiantes">
                                <option value="" disabled="" selected="">Selecciona una sección</option>
                                <?php
                                    while($fila=mysqli_fetch_array($selAllSection, MYSQLI_ASSOC)){
                        ...
                        <p class="text-center">
                            <button type="submit" class="btn btn-success">Mover estudiantes</button>
                        </p>
                    </div>
                    <?php 
                        endif;
                        mysqli_free_result($selAllSection);
                    ?>
                </div>
            </div>
        </form>
