            ...
            <div class="container-flat-form">
                ...
                <form action="../process/AddAdmin.php" method="post" class="form_SRCB" data-type-form="save" autocomplete="off">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-xs-12">
                                <legend class="all-tittles">INFORMACIÓN PERSONAL</legend><br>
                            </div>
                            <div class="col-xs-12">
                            ...
                            <div class="col-xs-12">
                                <div class="group-material">
                                    <input type="email" class="material-control tooltips-general" placeholder="E-mail" name="adminMail"  maxlength="50" data-toggle="tooltip" data-placement="top" title="Escribe el Email del administrador" required="">
                                    <span class="highlight"></span>
                                    <span class="bar"></span>
                                    <label>Email</label>
                                </div>
