                ...
                if($checktotal>0){
                    ...
                    while($fila=mysqli_fetch_array($checkSection, MYSQLI_ASSOC)){
                        ...
                        echo '<div class="div-table-row">
                            ...
                            if($dataTS['Nombre']!="" && $dataTS['Apellido']!=""){
                                echo '<div class="div-table-cell">'.$dataTS['Nombre'].' '.$dataTS['Apellido'].'</div>';
                            }else{
                                echo '<div class="div-table-cell">Sin asignar</div>';
                            }
                            echo '<div class="div-table-cell"><button class="btn btn-success btn-update" data-code="'.$fila['CodigoSeccion'].'" data-url="../process/SelectDataSection.php"><i class="zmdi zmdi-refresh"></i></button></div>';
