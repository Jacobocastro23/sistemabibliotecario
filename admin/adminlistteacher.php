        ...
        <div class="container-fluid">
            <form class="pull-right" style="width: 30% !important;" action="adminlistteacher.php" method="get" autocomplete="off">
                <div class="group-material">
                    <input type="search" style="display: inline-block !important; width: 70%;" class="material-control tooltips-general" placeholder="Buscar docente" name="TeacherN" required="" maxlength="50" data-toggle="tooltip" data-placement="top" title="Escribe los nombres,apellidos o matricula">
            ...
            <div class="table-responsive">
                <div class="div-table" style="margin:0 !important;">
                    <div class="div-table-row div-table-row-list" style="background-color:#DFF0D8; font-weight:bold;">
                        ...
                        <div class="div-table-cell" style="width: 15%;">Matricula</div>
            ...
            <?php
                if(!$TeacherN==""){
                    $selectTeacherByName=ejecutarSQL::consultar("SELECT * FROM docente WHERE Nombre like '%".$TeacherN."%' OR Apellido LIKE '%".$TeacherN."%' OR DUI LIKE '%".$TeacherN."%' ORDER BY Apellido ASC, Nombre ASC");
                                ...
                                <div class="table-responsive">
                                    <div class="div-table" style="margin:0 !important;">
                                        <div class="div-table-row div-table-row-list">
                                            ...
                                            if($dataT['CodigoSeccion']=="Sin asignar"){
                                                echo '<div class="div-table-cell" style="width: 15%;">'.$dataT['CodigoSeccion'].'</div>';
                                            }else{
                                                ...
                                                echo '<div class="div-table-cell" style="width: 15%;">'.$dataSt['Nombre'].'</div>';
                                                mysqli_free_result($seletSectt);
                                            }
                                            echo '<div class="div-table-cell" style="width: 15%;">'.$dataT['Apellido'].'</div>
                                ...
                                <div class="table-responsive">
                                    <div class="div-table" style="margin:0 !important;">
                                        <div class="div-table-row div-table-row-list">
                                            ...
                                            if($data['CodigoSeccion']=="Sin asignar"){
                                                echo '<div class="div-table-cell" style="width: 15%;">'.$data['CodigoSeccion'].'</div>';
                                            }else{
                                                ...
                                                echo '<div class="div-table-cell" style="width: 15%;">'.$dataS['Nombre'].'</div>';
                                                mysqli_free_result($seletSect);
                                            }
                                            echo '<div class="div-table-cell" style="width: 15%;">'.$data['Apellido'].'</div>
