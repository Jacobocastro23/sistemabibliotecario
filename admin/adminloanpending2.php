...
<body>
    ...
    <div class="content-page-container full-reset scroll">
        ...
        <br><br><br>
        <div class="container-fluid">
            <p class="lead text-center">Buscar por Código libro</p>
            <div class="row">
                            ...
                            <div class="row">
                                <div class="col-xs-12 col-md-4">
                                    <div class="group-material">
                                        <input type="search" class="material-control tooltips-general" placeholder="Código Libro" name="ukeyl" required="" maxlength="50" data-toggle="tooltip" data-placement="top" title="Escribe el Código Libro">
                                    </div>
                                </div>
                                <div class="col-xs-12 col-md-4">
                                    <div class="group-material">
