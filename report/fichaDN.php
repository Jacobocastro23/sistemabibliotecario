...
$pdf->Cell (0,5,iconv("UTF-8", "ISO-8859-1",'Registro de préstamos de libros de biblioteca a personal docente que laboran'),0,1,'C');
$pdf->Ln(7);
$pdf->Cell (0,5,iconv("UTF-8", "ISO-8859-1",'en el '.$dataInstitution['Nombre'].', durante el año '.$CurrentYear.''),0,1,'C');
$pdf->Ln(20);
$pdf->SetFont("Times","b",12);
$pdf->Cell (30,5,iconv("UTF-8", "ISO-8859-1",'Clave Institución: '),0);
$pdf->SetFont("Times","",12);
$pdf->Cell (37,5,iconv("UTF-8", "ISO-8859-1",$dataInstitution['CodigoInfraestructura']),0);
$pdf->SetFont("Times","b",12);
...
$pdf->Ln(12);
$pdf->SetFont("Times","b",12);
$pdf->Cell (26,5,iconv("UTF-8", "ISO-8859-1",'Especialidad: '),0);
$pdf->SetFont("Times","",12);
$pdf->Cell (70,5,iconv("UTF-8", "ISO-8859-1",$dataUser['Especialidad']),0);
$pdf->SetFont("Times","b",12);
$pdf->Cell (30,5,iconv("UTF-8", "ISO-8859-1",'Matricula: '),0);
$pdf->SetFont("Times","",12);
$pdf->Cell (25,5,iconv("UTF-8", "ISO-8859-1",$dataUser['DUI']),0);
$pdf->Ln(12);
$pdf->SetFont("Times","b",12);
...
$pdf->SetFont("Times","b",12);
$pdf->Cell (19,5,iconv("UTF-8", "ISO-8859-1",'Jornada: '),0);
$pdf->SetFont("Times","",12);
$pdf->Cell (40,5,iconv("UTF-8", "ISO-8859-1",$dataUser['Jornada']),0);
$pdf->Ln(10);
$pdf->SetFont("Times","",12);
...
$pdf->Ln(10);
$pdf->Cell (0,10,iconv("UTF-8", "ISO-8859-1",'Total libros prestados: '.$dataKey['Cantidad'].''),1);
$pdf->Ln(10);
