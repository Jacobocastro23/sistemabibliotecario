...
$sectionCode=consultasSQL::CleanStringText($_GET['section']);
...
while($DataALS=mysqli_fetch_array($selALoansP, MYSQLI_ASSOC)){
    ...
    if(mysqli_num_rows($selL)>0){
        ...
        if($sectionCode==$dataUS['CodigoSeccion']){
...
$pdf->Output('Devoluciones_pendientes_'.$section.'_'.$dataInstitution['Year'],'I');
