    ...
    <div class="content-page-container full-reset scroll">
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-xs-12">
                    <?php
                        if(is_file("assets/uploads/img/".$fila['Imagen'])){
                            echo '<img src="assets/uploads/img/'.$fila['Imagen'].'" class="img-responsive center-box" style="max-width: 300px;">';
                        }else{
                            echo '<img src="assets/img/book.png" class="img-responsive center-box" style="max-width: 300px;">';
                        }
                    ?>
                    <br>
                </div>
...
<style>
        ...
        /* ================== Contenedores ================== */
        .container-fluid {
            background-color: #f0fff0; /* verde muy suave */
            padding: 20px;
            border-radius: 10px;
            margin-bottom: 20px;
        }
