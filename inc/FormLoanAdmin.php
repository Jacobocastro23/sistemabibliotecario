    ...
    <div class="row">
        <div class="col-xs-12">
            ...
            <ul class="nav nav-tabs nav-justified" role="tablist">
                <li role="presentation" class="active"><a href="#loan5" aria-controls="messages" role="tab" data-toggle="tab">Préstamos múltiples</a></li>
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-sm-8 col-sm-offset-2">
                            <form action="process/AddLoanStudent.php" method="post" class="form_SRCB" data-type-form="saveLoan" autocomplete="off">
                                ...
                                <div class="group-material">
                                    <input type="text" class="material-control tooltips-general" id="inputStudents" placeholder="Escribe aquí la matricula del alumno" name="userKey" required="" maxlength="20" data-toggle="tooltip" data-placement="top" title="Matricula de estudiante">
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-sm-8 col-sm-offset-2">
                            <form action="process/AddLoanTeacher.php" method="post" class="form_SRCB" data-type-form="saveLoan" autocomplete="off"> 
                                ...
                                <div class="search-box">
                                    <i class="zmdi zmdi-search search-box-icon tooltips-general" data-toggle="tooltip" data-placement="top" title="Haz clic aquí para buscar la matricula del docente" data-id="formTeachers"></i>
                                ...
                                <div class="group-material">
                                    <input type="text" class="material-control tooltips-general" id="inputTeachers" placeholder="Escribe aquí el número de matricula del docente" name="userKey" pattern="[0-9-]{1,10}" required="" maxlength="10" data-toggle="tooltip" data-placement="top" title="Solamente números y guiones, 10 dígitos">
                                    <span class="highlight"></span>
                                    <span class="bar"></span>
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-sm-8 col-sm-offset-2">
                            <form action="process/AddLoanUsers.php" method="post" class="form_SRCB" data-type-form="saveLoan" autocomplete="off"> 
                                ...
                                ?>
                                <div class="search-box">
                                    <i class="zmdi zmdi-search search-box-icon tooltips-general" data-toggle="tooltip" data-placement="top" title="Haz clic aquí para buscar la matricula del personal ad." data-id="formPersonals"></i>
                                ...
                                <div class="group-material">
                                    <input type="text" class="material-control tooltips-general" id="inputPersonals" placeholder="Escribe aquí el número de identificacion del personal administrativo" name="userKey" pattern="[0-9-]{1,10}" required="" maxlength="10" data-toggle="tooltip" data-placement="top" title="Solamente números y guiones, 10 dígitos">
                                    <span class="highlight"></span>
                                    <span class="bar"></span>
                                    <label>Matricula</label>
                                </div>
                        ...
                        <div class="col-xs-12 col-sm-8 col-sm-offset-2">
                            <form action="process/AddLoanVisitor.php" method="post" class="form_SRCB" data-type-form="saveLoan" autocomplete="off"> 
                               <?php
                                ...
                                ?>
                                <div class="group-material">
                                    <input type="text" class="material-control tooltips-general" placeholder="Escribe aquí el número de identificacion del visitante" name="visitorDUI" pattern="[0-9-]{1,10}" required="" maxlength="10" data-toggle="tooltip" data-placement="top" title="Solamente números y guiones, 10 dígitos">
                                    <span class="highlight"></span>
                                    <span class="bar"></span>
