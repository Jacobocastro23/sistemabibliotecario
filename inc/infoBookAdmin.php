    ...
    <div class="row">
        <div class="col-xs-12">
            <div class="page-header">
              <h1 class="all-tittles">Datos de préstamos</h1>
            </div>
            <table class="table table-hover table-bordered">
                <thead>
                   <tr>
                       <th class="text-center">Ejemplares</th>
                       <th class="text-center">En préstamo</th>
                       <th class="text-center">Disponibles</th>
                       <th class="text-center">Préstamo devueltos</th>
                   </tr> 
                </thead>
                <tbody>
                    <tr>
                        <td class="text-center"><?php echo $fila['Existencias']; ?></td>
                        <td class="text-center"><?php echo $fila['Prestado']; ?></td>
                        <td class="text-center"><?php echo $fila['Existencias']-$fila['Prestado']; ?></td>
                        <td class="text-center">
                            <?php
                                $tlb=ejecutarSQL::consultar("SELECT * FROM prestamo WHERE CodigoLibro='".$fila['CodigoLibro']."' AND Estado='Entregado'");
                                echo mysqli_num_rows($tlb);
                            ?>
                        </td>
                    </tr>
                </tbody>
